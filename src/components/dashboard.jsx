          ...
          {data.map((data, index) => (
            <div key={index} className='w-11/12 px-14 py-3 bg-white rounded-xl shadow-md shadow-gray-700 flex gap-10'>
              ...
              <div className='flex items-center justify-end gap-4'>
                <button
                  className='bg-sky-400 w-32 h-16 rounded-xl text-white font-semibold text-xl hover:scale-75 transition-transform duration-300'>Edit
                </button>
                <button
                  className='bg-red-500 w-32 h-16 rounded-xl text-white font-semibold text-xl hover:scale-75 transition-transform duration-300'>Delete
                </button>
              </div>
            </div>
          ))}
